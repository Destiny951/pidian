...
export class McpServerModal extends Modal {
  ...
  onOpen() {
    ...
    this.modalEl.addClass('pidian-mcp-modal');
    ...
    this.typeFieldsEl = contentEl.createDiv({ cls: 'pidian-mcp-type-fields' });
    this.renderTypeFields();
    ...
    const buttonContainer = contentEl.createDiv({ cls: 'pidian-mcp-buttons' });
  ...
  private renderStdioFields() {
    ...
    cmdSetting.settingEl.addClass('pidian-mcp-cmd-setting');

    const cmdTextarea = cmdSetting.controlEl.createEl('textarea', {
      cls: 'pidian-mcp-cmd-textarea',
    });
    ...
    envSetting.settingEl.addClass('pidian-mcp-env-setting');

    const envTextarea = envSetting.controlEl.createEl('textarea', {
      cls: 'pidian-mcp-env-textarea',
    });
  ...
  private renderUrlFields() {
    ...
    headersSetting.settingEl.addClass('pidian-mcp-env-setting');
