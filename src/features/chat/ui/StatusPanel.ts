...
export class StatusPanel {
  ...
  private createPanel(): void {
    ...
    this.panelEl.className = 'pidian-status-panel';

    // Bash output container - hidden by default
    this.bashOutputContainerEl = document.createElement('div');
    this.bashOutputContainerEl.className = 'pidian-status-panel-bash';
    this.bashOutputContainerEl.style.display = 'none';

    this.bashHeaderEl = document.createElement('div');
    this.bashHeaderEl.className = 'pidian-tool-header pidian-status-panel-bash-header';
    ...
    this.bashContentEl.className = 'pidian-status-panel-bash-content';
    ...
    this.todoContainerEl.className = 'pidian-status-panel-todos';
    ...
    this.todoHeaderEl.className = 'pidian-status-panel-header';
    ...
    this.todoContentEl.className = 'pidian-status-panel-content pidian-todo-list-container';
  ...
  private renderTodoHeader(completedCount: number, totalCount: number, currentTask: TodoItem | undefined): void {
    ...
    if (!this.isTodoExpanded) {
      ...
      if (completedCount === totalCount && totalCount > 0) {
        ...
        status.className = 'pidian-status-panel-status status-completed';
      ...
      if (currentTask) {
        ...
        current.className = 'pidian-status-panel-current';
  ...
  private renderBashOutputs(options: { scroll?: boolean } = {}): void {
    ...
    headerIconEl.className = 'pidian-tool-icon';
    ...
    headerLabelEl.className = 'pidian-tool-label';
    ...
    previewEl.className = 'pidian-tool-current';
    ...
    summaryStatusEl.className = 'pidian-tool-status';
    ...
    actionsEl.className = 'pidian-status-panel-bash-actions';
  ...
  private renderBashEntry(info: PanelBashOutput): HTMLElement {
    ...
    entryLabelEl.className = 'pidian-tool-label';
    ...
    entryStatusEl.className = 'pidian-tool-status';
    ...
    contentEl.className = 'pidian-tool-content';
    ...
    rowEl.className = 'pidian-tool-result-row';

    const textEl = document.createElement('span');
    textEl.className = 'pidian-tool-result-text';
  ...
  private appendActionButton(
    ...
    el.className = `pidian-status-panel-bash-action pidian-status-panel-bash-action-${name}`;
