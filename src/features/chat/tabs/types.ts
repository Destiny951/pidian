...
/**
 * Minimal interface for the PidianView methods used by TabManager and Tab.
 * Extends Component for Obsidian integration (event handling, cleanup).
 * Avoids circular dependency by not importing PidianView directly.
 */
...
export interface TabData {
  ...
  /** Cached provider settings snapshot for synchronous access in UI callbacks. */
