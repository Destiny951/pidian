...
export interface ProviderRegistration {
  ...
  createTitleGenerationService: (plugin: PidianPlugin) => TitleGenerationService;
  createInstructionRefineService: (plugin: PidianPlugin) => InstructionRefineService;
  createInlineEditService: (plugin: PidianPlugin) => InlineEditService;
