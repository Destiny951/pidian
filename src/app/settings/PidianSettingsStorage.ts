...
import { DEFAULT_PIDIAN_SETTINGS } from './defaultSettings';
...
export type StoredPidianSettings = PidianSettings;
...
export class PidianSettingsStorage {
  constructor(private adapter: VaultFileAdapter) {}

  async load(): Promise<StoredPidianSettings> {
  ...
  async save(settings: StoredPidianSettings): Promise<void> {
  ...
  async update(updates: Partial<StoredPidianSettings>): Promise<void> {
  ...
  private getDefaults(): StoredPidianSettings {
    return DEFAULT_PIDIAN_SETTINGS;
  }
