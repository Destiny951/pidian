...
import { PidianSettingsStorage, type StoredPidianSettings } from '../settings/PidianSettingsStorage';

export class SharedStorageService implements SharedAppStorage {
  readonly claudianSettings: PidianSettingsStorage;
  ...
  constructor(plugin: Plugin) {
    ...
    this.claudianSettings = new PidianSettingsStorage(this.adapter);
  ...
  async savePidianSettings(settings: Record<string, unknown>): Promise<void> {
    await this.claudianSettings.save(settings as StoredPidianSettings);
  }
